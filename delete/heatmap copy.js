  ...
  d3.json(route).then(function(data) {
    ...
    geojson = L.choropleth(data.cases[0], {
      ...
      onEachFeature: function(feature, layer) {
        layer.bindPopup(`<h2 style="text-align:center;">${feature.properties.name}</h2><br><b>Confirmed Cases:</b> ${feature.properties.confirmed}<br><b>Recovered:</b> ${feature.properties.recovered}<br><b>Deaths:</b> ${feature.properties.deaths}`);
      }
    }).addTo(myMap);
    console.log(geojson)
